...
namespace number
{
const cv::String CarPlateNumberDetector_Russian::_haarCascadeCarPlateNumberRus(
    HAARCASCADE_CAR_PLATE_NUMBER_RUS);

CarPlateNumberDetector_Russian::CarPlateNumberDetector_Russian(
    const cv::String& imagePath) :
